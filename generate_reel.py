...
def build_metadata(word_pairs: list) -> tuple:
    ...
    title_variations = [
        ...
        "احفظ 5 كلمات انجليزي اليوم 🔥 #Shorts",
        "5 كلمات انجليزي هتحتاجها كل يوم ✅ #Shorts",
        "اختبر نفسك: تعرف هذه الكلمات؟ 👀 #Shorts",
        "ارفع مستواك في الانجليزي بهذه الكلمات 🚀 #Shorts",
        "5 كلمات انجليزي سهلة ومهمة 💡 #Shorts",
        "كلمات انجليزي لا تفوتك 🎯 #Shorts",
        "تعلم 5 كلمات انجليزي في أقل من دقيقة ⚡ #Shorts",
        "لو تتعلم انجليزي احفظ هذه الكلمات 📌 #Shorts",
        "5 كلمات انجليزي تخليك أذكى في المحادثة 💬 #Shorts",
        "كلمات انجليزي للمحادثة اليومية 🗣️ #Shorts",
        "خمس كلمات انجليزي لازم تكون عندك 🔥 #Shorts",
        "تعرف معنى هذه الكلمات بالانجليزي؟ 👀 #Shorts",
        "5 كلمات انجليزي جديدة لقاموسك 📚 #Shorts",
        "ابدأ يومك بـ 5 كلمات انجليزي ✅ #Shorts",
        "كلمات انجليزي مهمة للعرب 💪 #Shorts",
        "تعلم انجليزي بسرعة: 5 كلمات اليوم 🚀 #Shorts",
    ]
